  ...
  (let [pluto (first (tv/find-by-kv :name "pluto"))]
    (testing "Default/both traversals"
      ...
      (is (= (ad/degree-of pluto q/both) 
             6))
      (is (= (ad/degree-of pluto 
                           (q/subquery (q/both [:brother]))) 
             4))
      (is (= (ad/degree-of pluto 
                           (q/subquery (q/both [:brother :pet]))) 
             5))
      (is (= (ad/degree-of pluto 
                           (q/subquery (q/both [:brother :pet :lives]))) 
             6))
      (is (= (ad/degree-of pluto 
                           (q/subquery (q/both [:wrong_label]))) 
             0)))
    ...
    (testing "Out traversals"
      (is (= (ad/degree-of pluto q/out) 
             4))
      (is (= (ad/degree-of pluto 
                           (q/subquery (q/out [:pet]))) 
             1))
      (is (= (ad/degree-of pluto 
                           (q/subquery (q/out [:pet :lives]))) 
             2))
      (is (= (ad/degree-of pluto 
                           (q/subquery (q/out [:pet :lives :brother]))) 
             4))
      (is (= (ad/degree-of pluto 
                           (q/subquery (q/out [:wrong_label]))) 
             0)))
    ...
    (testing "In traversals"
      (is (= (ad/degree-of pluto
             ...
             2))
      (is (= (ad/degree-of pluto 
                           (q/subquery (q/in [:brother])))))
      (is (= (ad/degree-of pluto 
                           (q/subquery (q/in [:wrong_label]))) 
             0)))
    
    (testing "Subgraph inducing"
      (let [god-neighbors    (q/subquery
                              q/-->
                              (q/has :type "god"))
            brothers-homes (q/subquery 
                            (q/--> [:brother])
                            (q/--> [:lives]))]
  ...
  (testing "Total degrees"
    (let [vertices  (.getVertices (tg/get-graph))]
      (is (= (ad/degree-of vertices)
             (* 2 17)))
      (is (= (ad/degree-of vertices
                           (q/subquery q/<E> (q/has :time = nil)))
             (* 2 14)))
      (is (= (ad/degree-of vertices
                           (q/subquery q/<E> (q/has :time = (int 0))))
             (* 2 0)))
      (is (= (ad/degree-of vertices
                           (q/subquery q/<E> (q/has :time = (int 1))))
             (* 2 1)))
      (is (= (ad/degree-of vertices
                           (q/subquery q/<E> (q/has :time = (int 2))))
             (* 2 1)))
      (is (= (ad/degree-of vertices
                           (q/subquery q/<E> (q/has :time >= (int 3))))
             (* 2 1)))))
...
(deftest max-degree-test
  (let [vtxs (tv/get-all-vertices)]
    ...
    (is (= 5 (ad/max-degree vtxs (q/subquery (q/-->)))))
    (is (= 3 (ad/max-degree vtxs (q/subquery (q/<--)))))
    (is (= 4 (ad/max-degree vtxs (q/subquery (q/<-> [:brother])))))))

(deftest max-degree-test
  (let [vtxs (tv/get-all-vertices)]
    (is (= 1 (ad/min-degree vtxs)))
    (is (= 0 (ad/min-degree vtxs (q/subquery (q/-->)))))
    (is (= 0 (ad/min-degree vtxs (q/subquery (q/<--)))))
    (is (= 0 (ad/min-degree vtxs (q/subquery (q/<-> [:brother])))))))